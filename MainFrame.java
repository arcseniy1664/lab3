...
public class MainFrame extends JFrame {
	...
	public MainFrame(Double[] coefficients) {
		...
		Action showInfo = new AbstractAction("О программе") {
			public void actionPerformed(ActionEvent event) {
				JOptionPane.showMessageDialog(MainFrame.this,"Серба А., 6 группа" , " О программе", JOptionPane.INFORMATION_MESSAGE);
			}
		};
		
		aboutProgrammMenuItem = referenceMenu.add(showInfo);
